...
namespace myApp
{
    class nativeAPIplaystocksTask3
    { 
            ...
            try {
				...
				while (always) {
					...
					case "3":
						...
						long startPrint = DateTime.Now.Ticks;
		...
		public static void StoreStockData(IRIS irisNative, IRISConnection dbconnection)
		{
			...
			try {
				String sql = "select top 100 TransDate, Name, StockClose, StockOpen, High, Low, Volume from Demo.Stock";
